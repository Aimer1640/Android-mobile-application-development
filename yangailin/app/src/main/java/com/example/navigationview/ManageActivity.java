...
public class ManageActivity extends AppCompatActivity {
    ...
    private void selectData() {
        ...
        final ListView listView = findViewById(R.id.recycler_view);
        //绑定适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //无选择提示
                if (selectId == -1) {
                    Toast.makeText(getApplicationContext(), "请选择要修改的记录!", Toast.LENGTH_LONG).show();
                    return;
                }
                //判断是否有空数据
                if (edt_date.getText().toString().equals("") | edt_type.getText().toString().equals("") | edt_money.getText().toString().equals("") | edt_state.getText().toString().equals("")) {
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //无选择提示
                if (selectId == -1) {
                    Toast.makeText(ManageActivity.this, "请选择要删除的记录", Toast.LENGTH_LONG).show();
                    return;
                }

                //定义删除对话框
                AlertDialog dialog = new AlertDialog.Builder(ManageActivity.this).setTitle("删除操作")
                        .setMessage("是否确定删除所选记录")
        ...
        //统计页面
        //收支统计
        ImageView btn_calcmoney=findViewById(R.id.total);
