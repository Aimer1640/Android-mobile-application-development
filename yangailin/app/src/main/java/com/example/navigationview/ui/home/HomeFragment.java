    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        navView2.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id==R.id.billListFragment2) {
                    navController.navigate(R.id.billListFragment2);
                }
                if(id==R.id.queryBillFragment) {
                    navController.navigate(R.id.queryBillFragment);
                }
                if(id==R.id.myPageFragment) {
